...
This chapter of the report discusses the decisions made in designing and implementing the system for supporting the migration of software from a Parallax Propeller Activity Board to an Arduino (these will be referred to as the source and target respectively). The system is implemented as an Eclipse plugin to assist in usability. Firstly, the high-level architecture of the plugin will be presented in Section \ref{high_lev_arch} along with the design rationale. This will be followed by an examination of the low-level architecture of these components in Section \ref{low_lev_arch}. Finally the implementation details of the system will be discussed in Section \ref{impl}.
...
\section{Low-Level Architecture} \label{low_lev_arch}
\subsection{Fritzing Netlist Analysis}
\begin{figure}[h!]
...
\subsection{Arduino Library Analysis}
\begin{figure}[h!]
  \begin{center}
...
\subsection{Parallax Project Analysis}
\begin{figure}[h!]
  \begin{center}
