...
\item The approach will be considered successful if it is shown to work for a case study of reasonable complexity. Due to the time constraints of the project, it is not expected that the system will work for all cases.
