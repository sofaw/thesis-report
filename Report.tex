...
This case study is used to demonstrate the migration of code for components that require different complexities of mapping between the source and target platforms. Firstly, mapping betweenuse of two functionalities that require the use of platform libraries: the servo motors and a humidity/temperature sensor. 
%TODO: description of why this case study chosen
%TODO: analysis of migration
%TODO: add results in table
