...
\section{Overview}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{graphics/high_level_overview.png}
  \caption{A high-level overview of the system.}
  \label{fig:high_level_overview}
\end{figure}
// TODO

\section{Fritzing Netlist Analysis}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{graphics/fritzing_analysis.png}
...
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{graphics/arduino_library_analysis.png}
  \caption{A more detailed view of the Arduino library analysis component of the system.}
  \label{fig:arduino_analysis}
\end{figure}
// TODO

\section{Parallax Project Analysis}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{graphics/parallax_project_analysis.png}
