...
%TODO: pin generation queries doesn't handle case where >1 sensor is connected to a board pin; config information has not been provided for all components in Fritzing due to time constraints
