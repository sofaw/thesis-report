...
\wordcount{0}
\excludes{Appendices \ref{first_appendix} to \ref{last_appendix}}
...
This project aims to tackle the particular software obsolescence problem of migrating software between hardware platforms - in this case the Parallax Propeller Activity Board and Arduino Uno microcontrollers. In particular, the project will utilise MDE to achieve this goal.}

\acknowledgements{I would like to thank Simos Gerasimou for his guidance and support throughout this project.}

\statementofethics{This project did not use any human participants.}
%TODO add statement of which appendices are marked
