...
\subsection{Software Obsolescence}
...
% Gen. sw obs.
% Past approaches
% Discussion of lit. review
% Sandborn et al. software license downgrade/source code purchase \parencite{sandborn2007obsolescence}
% Recent MDE approaches
% Kowalczyk MDSM \parencite{kowalczyk2009model}
% Sodifrance \parencite{fleurey2007model}
% Microprocessor specific
% atmel 8-bit to 32-bit \parencite{wilbrink2004facilitating}
% York strategy \parencite{gerasimou2017technical}
% Introduction to my approach
% Including potential pros/cons
...
% MDE - how these approaches are effective and may be applied to the microprocessor problem
% Kowalczyk MDSM \parencite{kowalczyk2009model}
% Sodifrance \parencite{fleurey2007model}
...
% TODO read related works to the sodifrance paper
...
%TODO discuss testing in relation to MDE


\subsection{Migration Between Microcontrollers}
MDE processes have yet to be applied to software migration between microcontrollers. 

Atmel dev
% Microprocessor specific
% atmel 8-bit to 32-bit \parencite{wilbrink2004facilitating}
% York strategy \parencite{gerasimou2017technical}
My project aims to explore the feasibility of applying the MDE approach similar to that demonstrated in \parencite{fleurey2007model} and \parencite{kowalczyk2009model}
% Introduction to my approach
% Including potential pros/cons
